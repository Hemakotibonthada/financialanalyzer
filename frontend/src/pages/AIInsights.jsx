...
const AIInsights = () => {
  ...
  const fetchInsights = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`/api/insights?period=${period}`, {
        headers: {
  ...
  if (loading) {
    return (
      <>
        <Sidebar />
        <div className="lg:ml-72 min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
          <div className="text-center">
            <RefreshCw className="w-16 h-16 text-indigo-600 animate-spin mx-auto mb-4" />
            <p className="text-gray-600 font-medium">Analyzing your financial data...</p>
          </div>
        </div>
      </>
    );
  ...
  if (error) {
    return (
      <>
        <Sidebar />
        <div className="lg:ml-72 min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-8">
          <div className="max-w-4xl mx-auto">
            <div className="bg-red-50 border border-red-200 rounded-xl p-6 text-center">
              <AlertTriangle className="w-12 h-12 text-red-500 mx-auto mb-3" />
              <h3 className="text-lg font-bold text-red-800 mb-2">Error Loading Insights</h3>
  ...
  return (
    <>
      <Sidebar />
      <div className="lg:ml-72 min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
              ...
              <h3 className="text-sm font-medium text-gray-600">Recurring Payments</h3>
              <p className="text-xs text-gray-500 mt-1">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500">
              ...
              <h3 className="text-sm font-medium text-gray-600">EMI Burden</h3>
              <p className="text-xs text-gray-500 mt-1">
          ...
          <div className="bg-white rounded-xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Personalized insights to improve your financial health</p>
              </div>
            </div>
            ...
            {insights.recommendations && insights.recommendations.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">Your finances are in excellent shape. Keep up the good work!</p>
              </div>
            )}
          </div>
          ...
          {insights.recurringTransactions && insights.recurringTransactions.length > 0 && (
            <div className="bg-white rounded-xl shadow-xl p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Recurring Transactions Detected</h2>
                  <p className="text-gray-600">AI-detected patterns in your spending</p>
                </div>
              </div>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-gray-900">₹{transaction.averageAmount.toLocaleString()}</span>
                      </div>
                      
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Frequency</span>
                        <span className="capitalize text-gray-900 font-medium">{transaction.frequency}</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-semibold text-gray-700">{transaction.confidence}%</span>
                        </div>
                      </div>

                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Occurrences</span>
                        <span className="text-gray-900 font-medium">{transaction.occurrences}x</span>
                      </div>
