    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-700">No Debts Found</h2>
          <p className="text-gray-500 mt-2">You're debt-free! Keep up the good work!</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Strategic debt payoff planning and optimization</p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-xl font-bold text-gray-900">Extra Monthly Payment</h3>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Debt Distribution</h3>
                <div className="h-80">
                  {debtData.debts && (
                    <Doughnut
                      data={{
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Interest Rate Comparison</h3>
                <div className="h-80">
                  {debtData.debts && (
                    <Bar
                      data={{
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  {debtData.recommendations.map((rec, index) => (
                    <div key={index} className="p-4 bg-indigo-50 border-l-4 border-indigo-600 rounded">
                      ...
                      {debtData.selectedStrategy.payoffOrder.map((debt, index) => (
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          ...
                          <div className="text-right">
                            ...
                            <div className="font-bold text-gray-900">₹{debt.balance?.toLocaleString()}</div>
                          </div>
                        </div>
                      ))}
                    </div>
        ...
        {activeTab === 'schedule' && debtData.selectedStrategy && (
          <div className="space-y-6">
            {/* Timeline Chart */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Payoff Timeline</h3>
              <div className="h-80">
            ...
            {debtData.selectedStrategy.schedule && (
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Monthly Payment Schedule</h3>
  ...
  return (
    <div
      ...
      className={`relative p-6 border-2 rounded-lg cursor-pointer transition-all ${
        selected ? `${colors[color]} shadow-lg` : 'border-gray-200 bg-white hover:border-gray-300'
      }`}
    >
      {recommended && (
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="grid grid-cols-3 gap-4 text-center">
        <div className="p-3 bg-gray-50 rounded-lg">
          ...
          <div className="text-sm font-bold text-gray-900">₹{debt.minimumPayment?.toLocaleString()}</div>
        </div>
        <div className="p-3 bg-gray-50 rounded-lg">
          <div className="text-xs text-gray-600">Remaining Months</div>
          <div className="text-sm font-bold text-gray-900">{debt.remainingMonths}</div>
        </div>
        <div className="p-3 bg-gray-50 rounded-lg">
          <div className="text-xs text-gray-600">Original Amount</div>
          <div className="text-sm font-bold text-gray-900">₹{debt.originalAmount?.toLocaleString()}</div>
        </div>
      </div>
    </div>
  );
