  ...
  if (!monthlyData || !Array.isArray(monthlyData) || monthlyData.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-500">No EMI trend data available yet. Sync your statements to see monthly trends.</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow">
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <h3 className="text-lg font-medium text-gray-900">📊 EMI Monthly Trends</h3>
            <p className="text-sm text-gray-600 mt-1">Your EMI payment patterns over time</p>
          </div>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-4 border border-red-200">
            ...
            <p className="text-xs text-red-600 mt-1">Avg Monthly Burden</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 border border-orange-200">
            ...
            <p className="text-xs text-orange-600 mt-1">Highest Month</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
            ...
            <p className="text-xs text-green-600 mt-1">Lowest Month</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
            ...
            <p className="text-xs text-blue-600 mt-1">Total Payments</p>
          </div>
        </div>
        ...
        <div className="mb-6 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg border border-amber-200">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <p className="text-sm font-medium text-amber-800">Peak EMI Month</p>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-amber-600">EMIs</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{monthlyData.length} months</p>
            </div>
            <div>
